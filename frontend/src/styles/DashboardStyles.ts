const DashboardStyles = {
  container: "min-h-screen w-full flex flex-col md:flex-row bg-white relative",
  mobileToggle:
  ...
  toggleIcon: "text-2xl",
  sidebar:
    "bg-white text-gray-700 w-64 py-7 px-4 mt-14 md:mt-0 shadow-md flex flex-col justify-between transition-transform duration-300 absolute z-30 md:relative", // Set flex-col and justify-between
  ...
  mainContent: "flex-1 px-10 text-gray-800",
};
