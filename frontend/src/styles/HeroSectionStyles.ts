const HeroSectionStyles = {
  section:
    "relative flex flex-col md:flex-row items-center bg-white text-black px-2 py-8 md:px-8",
  textContainer: "w-full md:w-1/2 p-0 md:p-6 z-10 text-center md:text-left",
